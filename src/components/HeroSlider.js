              ...
              <div className='container mx-auto text-center lg:text-left'>
                <div className='flex flex-col justify-between items-center lg:flex-row'>
                  <div className='flex-1'>
                    ...
                    <button className='flex items-center bg-[#008000] rounded-xl justify-center p-4 text-white gap-4 text-xl hover:scale-110 transition-all ease-out mb-8 lg:mb-0'>
                    <FaWhatsapp size={20}/> {buttonText}
                    </button>
                  </div>
